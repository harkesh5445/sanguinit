...
$page_data = [
    'title' => 'Full Website Audit Services | SanguineIT',
    'description' => 'Comprehensive website audits — SEO, performance, Core Web Vitals, accessibility, security, and UX reviews with actionable improvement roadmaps.',
    'keywords' => 'website audit, SEO audit, performance audit, Core Web Vitals, site health check, SanguineIT',
    'canonical' => sit_base_url() . '/full-website-audit.php',
];
include 'header.php';
?>
						...
						<div class="row justify-content-center">
							<div class="col-lg-7">
								<div class="bread-titlev2">
									<h1 class="wow fadeInUp" data-wow-delay=".2s" style="color: #fff;">Full Website Audit</h1>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/audit_1.jpg', 'Full website audit and SEO analysis', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<span>Overview</span>
									<h2>Comprehensive Website Audits for Search, Speed &amp; Conversion</h2>
									<p class="lh">SanguineIT delivers full website audits that go beyond surface-level SEO checklists — combining technical SEO, Core Web Vitals, accessibility, security headers, mobile usability, and content structure into one prioritized improvement plan.</p>
									<p class="lh">Our audits help marketing and engineering teams understand why rankings stall, pages load slowly, or conversions drop — with clear fixes ranked by impact and implementation effort for global sites on WordPress, Magento, Sitefinity, and custom stacks.</p>
									<p class="lh">Post-audit, our teams can implement fixes through <a href="custom-web-development.php">web development</a> and <a href="website-maintenance-and-support-services.php">maintenance</a> programs.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<h2>Full audit coverage areas</h2>
									<p class="lh">
									<ul class="listing">
									<li><b>Technical SEO —</b> Crawlability, indexation, canonicals, structured data, and internal linking.</li>
									<li><b>Performance &amp; CWV —</b> LCP, INP, CLS analysis with asset, cache, and server recommendations.</li>
									<li><b>Mobile usability —</b> Responsive issues, tap targets, and mobile-first indexing readiness.</li>
									<li><b>Accessibility —</b> WCAG-oriented checks for contrast, labels, keyboard navigation, and ARIA usage.</li>
									<li><b>Security headers —</b> HTTPS, HSTS, CSP, and cookie configuration review.</li>
									<li><b>Content &amp; UX —</b> Page intent alignment, duplicate content, and conversion path friction.</li>
</ul>
</p>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/audit_2.jpg', 'Website performance and Core Web Vitals audit', ['class' => 'img-fluid']); ?>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/audit_3.jpg', 'Website audit report and remediation roadmap', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<h2>Audit deliverables your teams can execute</h2>
									<p class="lh">Every audit includes an executive summary, severity-ranked issue list, and implementation roadmap — sized for both marketing quick wins and engineering backlog items. We avoid vanity scores in favor of changes that move organic traffic, page speed, and conversion metrics.</p>
									<p class="lh">Read SEO insights on our <a href="blogs.php">blog</a>, pair with <a href="security-auditing.php">security auditing</a>, or <a href="contact-us.php">request a website audit</a>.</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row upset link-hover">
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
								<div class="s-block">
									...
									<p class="lh">Crawl, index, schema, and linking analysis with fix priorities.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s">
								<div class="s-block">
									...
									<p class="lh">Speed bottlenecks and CWV improvement recommendations.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s">
								<div class="s-block">
									...
									<h4>Mobile &amp; UX Review</h4>
									<p class="lh">Responsive design, usability, and conversion path analysis.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s">
								<div class="s-block">
									...
									<p class="lh">WCAG-oriented review for inclusive user experiences.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay="1s">
								<div class="s-block">
									...
									<p class="lh">HTTPS, HSTS, CSP, and cookie security configuration.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay="1.2s">
								<div class="s-block">
									...
									<p class="lh">Engineering teams to execute audit recommendations post-review.</p>
								</div>
							</div>
						</div>
						<div class="-cta-btn mt70">
							<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.3s">
								<p class="lh">Need a <span>Website Audit</span>?</p>
