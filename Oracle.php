...
$page_data = [
    'title' => 'Oracle Database Services | SanguineIT',
    'description' => 'Oracle database development and support — PL/SQL optimization, RAC, Data Guard, cloud migration to Oracle Cloud and AWS, for enterprise applications worldwide.',
    'keywords' => 'Oracle database development, Oracle DBA, PL/SQL, Oracle Cloud, SanguineIT',
    'canonical' => sit_base_url() . '/Oracle.php',
];
include 'header.php';
?>
						...
						<div class="row justify-content-center">
							<div class="col-lg-7">
								<div class="bread-titlev2">
									<h1 class="wow fadeInUp" data-wow-delay=".2s" style="color: #fff;">Oracle Database Services</h1>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/data_1.jpg', 'Oracle database development services', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<span>Overview</span>
									<h2>Oracle Database Engineering for Enterprise Workloads</h2>
									<p class="lh">SanguineIT supports Oracle database environments for enterprises running ERP extensions, financial systems, and high-volume transactional applications — with PL/SQL development, performance tuning, RAC configuration, Data Guard DR, and cloud migration planning.</p>
									<p class="lh">Our Oracle work integrates with Java and .NET application teams and aligns to change-control processes enterprise DBAs require.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<h2>Oracle capabilities we deliver</h2>
									<p class="lh"><ul class="listing">
									<li><b>PL/SQL development —</b> Packages, procedures, and triggers for business logic layers.</li>
									<li><b>Performance tuning —</b> AWR analysis, SQL plan management, and index strategy.</li>
									<li><b>High availability —</b> RAC, Data Guard, and disaster recovery configuration.</li>
									<li><b>Cloud migration —</b> On-premise to Oracle Cloud Infrastructure planning.</li>
									<li><b>Security &amp; auditing —</b> Vault, TDE, and compliance-ready audit trails.</li>
									<li><b>Migration off Oracle —</b> PostgreSQL migration assessment where TCO warrants.</li>
</ul></p>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/data_2.jpg', 'Oracle PL/SQL and performance tuning', ['class' => 'img-fluid']); ?>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/data_3.jpg', 'Oracle enterprise database support', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<h2>Oracle estates managed with operational discipline</h2>
									<p class="lh">Oracle environments carry licensing and operational complexity that rewards experienced partners. SanguineIT helps teams optimize what they have, migrate where it makes sense, and keep production stable through patch cycles.</p>
									<p class="lh"><a href="database-auditing.php">Database auditing</a> or <a href="contact-us.php">contact us</a> for an Oracle assessment.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
						...
						<div class="-cta-btn mt70">
							<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.3s">
								<p class="lh">Need <span>Oracle Database Expertise</span>?</p>
