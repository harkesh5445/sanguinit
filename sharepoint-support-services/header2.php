...
<head>
   ...
   <!-- Main Stylesheets -->
   <link href="sharepoint-support-services/style2.css" rel="stylesheet">
   <link href="css/responsive.css" rel="stylesheet">
   <link href="css/portfolio.css" rel="stylesheet">
   <link href="sharepoint-support-services/custom.css" rel="stylesheet">

   <!-- Performance optimized CSS for clients section -->
   <link href="sharepoint-support-services/clients-section-optimized.css" rel="stylesheet">
...
<body class="loading">
   ...
   <header class="nav-bg-b main-header navfix fixed-top menu-white header-pr">
      <div class="container-fluid m-pad x-pad">
         <div class="menu-header">
            ...
            <?php include "components/navigation-menu.php"; ?>
