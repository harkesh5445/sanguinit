						...
						<div class="row justify-content-center">
							<div class="col-lg-7">
								<div class="bread-titlev2">
									<h1 class="wow fadeInUp" data-wow-delay=".2s" style="color: #fff;">Need A Premium & Creative Website Designing?</h1>
						...
						<div class="row">
							...
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									...
									<p class="lh">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum is simply dummy text of the printing and typesetting industry.  Lorem Ipsum is simply dummy text of the printing and typesetting industry. is simply dummy text of the printing and typesetting industry. </p>
									<p class="lh">Lorem Ipsum is simply dummy text of the printing and typesetting industry.  Lorem Ipsum is simply dummy text of the printing and typesetting industry. is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row upset link-hover">
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
								<div class="s-block">
									...
									<p class="lh">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						...
						<div class="row upset justify-content-center mt60">
							...
							<div class="col-lg-7 v-center order2">
								<div class="ps-block">
									...
									<p class="lh">Donec metus lorem, vulputate at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. Aliquam tristique libero at dui sodales, et placerat orci lobortis. Maecenas ipsum neque, elementum id dignissim et, imperdiet vitae mauris.</p>
								</div>
							</div>
						</div>
						<div class="row upset justify-content-center mt60">
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<div class="common-heading ptag">
									...
									<p class="lh mb30">Donec metus lorem, vulputate at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit.</p>
								</div>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p class="lh">In vel hendrerit nisi. Vestibulum eget risus velit.</p>
									</div>
								</div>
							</div>
						...
						<div class="-cta-btn mt70">
							<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.8s">
								<p class="lh">Let's Start a <span>New Project</span> Together</p>
						...
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<div class="common-heading ptag">
									<span>Pricing</span>
									<h2>Pricing Table</h2>
									<p class="lh mb0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
						<div class="row justify-content-center">
							<div class="col-lg-4 col-md-6">
								<div class="pricing-table mt60">
									<div class="inner-table">
										...
										<p class="lh title-sub">Great For Small Business</p>
										<h2><sup>$</sup> 79.99</h2>
										<p class="lh duration">Monthly Package</p>
										<div class="details">
											<ul>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-6">
								<div class="common-heading ptag">
									...
									<p class="lh mb0">We think big and have hands in all leading technology platforms to provide you wide array of services.</p>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-lg-4 wow fadeInUp" data-wow-delay=".8s">
								<div class="isotope_item hover-scale">
									...
									<div class="item-info">
										...
										<p class="lh">Android & iOs, Design</p>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-lg-12 maga-btn mt60">
								<a href="#" class="btn-outline">View More Projects <i class="fas fa-chevron-right fa-icon"></i></a>
							</div>
						</div>
					</div>
				</section>
						...
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<div class="common-heading ptag">
									...
									<h2>Client Speaks</h2>
									<p class="lh mb30">Check our customers success stories.</p>
								</div>
							</div>
						</div>
						<div class="row">
								...
								<div class="reviews-card pr-shadow">
									...
									<div class="-client-details-">
										<div class="reviewer-text">
											<h4>Sue Vaneer</h4>
											<p class="lh">Business Owner, <small>Jaipur</small></p>
											<div class="star-rate">
												<ul>
