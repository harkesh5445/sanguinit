      ...
      <div class="row">
        <div class="col-md-4 mt30">
          <div class="reviews-card pr-shadow">
            <div class="row v-center">
              ...
              <div class="col"> <span class="revbx-rl"><img src="images/client/final-green-cabs-PhotoRoom.png-PhotoRoom-1.webp" alt="review service logo"></span> </div>
            </div>
            <div class="review-text">
              <p>Outstanding mobile app development company! Their unmatched expertise shines from concept to execution, delivering top-notch solutions. Highly recommend their innovative approach for seamless app development. With their team, expect nothing less than excellence in every phase of your project journey.</p>
            </div>
        ...
        <div class="col-md-4 mt30">
          <div class="reviews-card pr-shadow">
            <div class="row v-center">
              <div class="col"> <span class="revbx-lr"><i class="fas fa-quote-left"></i></span> </div>
              <div class="col"> <span class="revbx-rl"><img src="images/client/JumbotailLogo1.png" alt="review service logo"></span> </div>
            </div>
            <div class="review-text">
              <p>This IT company exceeded my expectations! With unparalleled technical prowess, they crafted robust solutions tailored to our needs. Their proactive approach and stellar support ensured smooth operations. Trustworthy, reliable, and innovative, they're our go-to for all IT requirements. Highly recommend their services for transformative technological solutions..</p>
            </div>
            <div class="-client-details-">
              <div class="-reviewr">
              ...
              <div class="reviewer-text">
                <h4>Merry Cruiser</h4>
                <p>Business Owner, <small>US</small></p>
                <div class="star-rate">
                  <ul>
                    <li> <a href="javascript:void(0)" class="chked"><i class="fas fa-star" aria-hidden="true"></i></a> </li>
                    <li> <a href="javascript:void(0)" class="chked"><i class="fas fa-star" aria-hidden="true"></i></a> </li>
        ...
        <div class="col-md-4 mt30">
          <div class="reviews-card pr-shadow">
            <div class="row v-center">
              <div class="col"> <span class="revbx-lr"><i class="fas fa-quote-left"></i></span> </div>
              <div class="col"> <span class="revbx-rl"><img src="images/client/th _1_.png" alt="review service logo"></span> </div>
            </div>
            <div class="review-text">
              <p>Exceptional web development company! Their creativity and attention to detail are unmatched. From design to functionality, they deliver stunning websites that exceed expectations. With prompt communication and reliable support, they ensure a seamless experience. Highly recommend their services for captivating and user-friendly web solutions.</p>
            </div>
            <div class="-client-details-">
              <div class="-reviewr">
              ...
              <div class="reviewer-text">
                <h4>Ragnar Sthesia</h4>
                <p>Business Owner, <small>UK</small></p>
                <div class="star-rate">
                  <ul>
                    <li> <a href="javascript:void(0)" class="chked"><i class="fas fa-star" aria-hidden="true"></i></a> </li>
                    <li> <a href="javascript:void(0)" class="chked"><i class="fas fa-star" aria-hidden="true"></i></a> </li>
