...
$newsPosts = [
    ...
    'sitefinity-cve-2025-3600-patch-immediately' => [
        'title' => 'CMS Security Alert: Critical CVE With Active Exploitation — Patch Immediately',
        'date' => 'October 23, 2025',
        'category' => 'Technology News',
        'category_slug' => 'technology',
        'featured_image' => 'images/news/sitefinity-security.jpg',
        'list_summary' => 'Active exploitation of a critical CMS vulnerability puts enterprise websites at elevated risk; SanguineIT outlines immediate remediation and hardening priorities.',
    ],
    'adobe-commerce-october-2025-security-patches' => [
        'title' => 'October 2025 Security Advisory: Critical Patches for Web Applications and CMS Platforms',
        'date' => 'October 23, 2025',
        'category' => 'Technology News',
        'category_slug' => 'technology',
        'featured_image' => 'images/news/commerce-security.jpg',
        'list_summary' => 'Critical security patches for widely deployed web frameworks and CMS platforms require urgent staging and deployment to reduce admin and customer data exposure risks.',
    ],
