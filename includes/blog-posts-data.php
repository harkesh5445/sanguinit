...
$blogPosts = [
    ...
    'magento-security-patches-guide' => [
        ...
        'list_excerpt' => 'Magento stores process payments and personal data daily—delayed patches are a business risk. This guide explains patch severity, staging workflows, and maintenance discipline SanguineIT uses for merchant clients.',
    ...
    'sitefinity-15-upgrade-enterprise-portals' => [
        'title' => 'Sitefinity 15 Upgrade Checklist for Enterprise Portals',
        'date' => 'March 14, 2026',
        'comments' => 2,
        'category' => 'Sitefinity',
        'category_slug' => 'sitefinity',
        'featured_image' => 'images/blog/sitefinity-enterprise.jpg',
        'list_excerpt' => 'Upgrading Sitefinity across large content estates requires environment readiness, widget audits, and launch validation. Use this enterprise checklist before your next portal upgrade.',
        'excerpt' => 'Readiness assessments, migration sequencing, and post-go-live validation for Sitefinity enterprise upgrades.',
        'toc' => [
    ...
    'headless-commerce-performance-flexibility' => [
        ...
        'list_excerpt' => 'Headless commerce decouples storefront experience from backend services so teams ship faster across web, mobile, and marketplaces. Learn when headless fits—and how to avoid common architecture mistakes.',
        'excerpt' => 'Practical guide to evaluate and implement headless commerce architecture for modern storefronts.',
        'toc' => [
