...
$page_data = [
    'title' => 'SQLite Development & Integration | SanguineIT',
    'description' => 'SQLite database integration — embedded databases for mobile apps, desktop applications, IoT devices, and offline-first sync architectures.',
    'keywords' => 'SQLite development, embedded database, mobile offline database, SQLite integration, SanguineIT',
    'canonical' => sit_base_url() . '/SQLite.php',
];
include 'header.php';
?>
						...
						<div class="row justify-content-center">
							<div class="col-lg-7">
								<div class="bread-titlev2">
									<h1 class="wow fadeInUp" data-wow-delay=".2s" style="color: #fff;">SQLite Development</h1>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/data_4.jpg', 'SQLite embedded database development', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<span>Overview</span>
									<h2>SQLite for Embedded &amp; Offline-First Applications</h2>
									<p class="lh">SanguineIT integrates SQLite databases into mobile apps, desktop applications, Electron apps, and IoT devices that need reliable local storage with optional sync to cloud backends — ideal for offline-first field tools and consumer apps.</p>
									<p class="lh">Our engineers design sync strategies, conflict resolution, schema migrations for embedded stores, and encryption for sensitive local data — paired with <a href="android.php">Android</a>, <a href="ios.php">iOS</a>, and <a href="Electron-JS.php">Electron</a> development.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<h2>SQLite capabilities we deliver</h2>
									<p class="lh"><ul class="listing">
									<li><b>Embedded schema design —</b> Lightweight models optimized for mobile and desktop storage.</li>
									<li><b>Offline sync —</b> Queue-based sync with conflict resolution to server databases.</li>
									<li><b>Encryption —</b> SQLCipher and platform-native secure storage integration.</li>
									<li><b>Migration strategy —</b> Versioned schema upgrades for app updates.</li>
									<li><b>Performance —</b> WAL mode, indexing, and query optimization for device constraints.</li>
									<li><b>Testing —</b> In-memory SQLite for automated test suites.</li>
</ul></p>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/data_5.jpg', 'SQLite mobile offline database integration', ['class' => 'img-fluid']); ?>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/app_3.jpg', 'SQLite offline-first application engineering', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<h2>Local data layers that sync reliably</h2>
									<p class="lh">Offline-first apps fail when sync logic is an afterthought. SanguineIT designs SQLite integration as part of the application architecture — with clear ownership of conflict resolution and retry semantics.</p>
									<p class="lh"><a href="contact-us.php">Contact us</a> for an offline-first architecture review.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
						...
						<div class="-cta-btn mt70">
							<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.3s">
								<p class="lh">Need <span>SQLite Integration Help</span>?</p>
