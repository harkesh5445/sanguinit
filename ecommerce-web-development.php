						...
						<div class="row justify-content-center">
							<div class="col-lg-7">
								<div class="bread-titlev2">
									<h1 class="wow fadeInUp" data-wow-delay=".2s" style="color: #fff;">eCommerce web development</h1>
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<img src="images/about_2/ecno_1.jpg" alt="image" class="img-fluid"/>
								</div>
							</div>
...
<li><b>Sensible Price - </b>Our eCommerce improvement administrations are truly moderate in nature and guarantee that you get an incentive for cash through the administrations. We will improve your worldwide reach. 
							...
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<img src="images/about_2/cost_2.jpg" alt="image" class="img-fluid"/>
								</div>
							</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<img src="images/about_2/cost_3.jpg" alt="image" class="img-fluid"/>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
								
									<h2>MAKE YOUR E-COMMERCE PORTAL USER-FRIENDLY </h2>
									<p class="lh">Building up your Arcade of eCommerce with SanguineIT 

We have a group of master experts, engineers, and task chiefs who will build up your eCommerce stage. We guarantee that our clients get the most ideal guide with your eCommerce stage. We have made various eCommerce answers for every one of our customers, offering thoughts to vendors worldwide into creating eCommerce models for their business. 
</p>
									<p class="lh">

Internet business is the most recent pattern that is trailed by the organizations around the world. You can get every one of your items and administrations over the web with the simple arrangement of an eCommerce stage. With the accessibility of online installment passage, incorporation with the transportation organizations all you require is our vigorous backend assist that with willing build up their eCommerce arrangements. 

We are a client situated organization making every one of our customers appreciate the products of web based business entryway. Making shopping simple for clients with the eCommerce stage</p>
								</div>
							</div>
						</div>
					</div>
