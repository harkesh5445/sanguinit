...
<link rel='stylesheet' id='ultimate_blocks-cgb-style-css-css' href='https://www.thecreativeworks.com.au/wp-content/plugins/ultimate-blocks/dist/blocks.style.build.css?ver=65eae55a9124c' type='text/css' media='all' />
...
<meta name="generator" content="WordPress 6.4.3" />
	...
	<meta name="msapplication-TileImage" content="https://www.thecreativeworks.com.au/wp-content/uploads/2022/12/cropped-apple-icon-114x114-1-270x270.png" />
        ...
        nav.pt-30.pb-30.lh-40.navigation_2.bg-dark {
    display: none;
}
        ...
        <nav class="pt-30 pb-30 lh-40 navigation_2 bg-dark">
            <div class="container px-xl-0">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-2 col-lg-3 text-center text-lg-left"><a class="mr-20 link img_link w-350" href="https://www.thecreativeworks.com.au"> <img alt="Logo" class="img-fluid" data-aos="fade-down" data-aos-delay="0" src="https://www.thecreativeworks.com.au/wp-content/uploads/2022/08/logo.svg"> </a>
                    </div>
                                                    <div class="menu text-md-right" data-aos="fade-down" data-aos-delay="500" id="menu-landing"><a class="link mx-15 color-white menu-item menu-item-type-custom menu-item-object-custom menu-item-2518" id="menu-item-2518"  href="#services">SERVICES</a>
...
<form action="/campaigns/website-development/?gad_source=1&#038;gclid=EAIaIQobChMI6Y3k8cLhhAMV06tmAh1UDw7tEAAYBCAAEgLwC_D_BwE#wpcf7-f2516-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
...
<div class="row" data-pg-collapsed>
	<div class="col-sm-12">
		<h2 class="mb-30 small text-adaptive aos-init aos-animate" data-aos="fade-down" data-aos-delay="0">Let us help you
		</h2>
	</div>
</div>
<div class="row" data-pg-collapsed>
...
<div class="row justify-content-between align-items-center">
	<div class="col-sm-12 actions-wrapper">
		<p><input class="wpcf7-form-control wpcf7-submit has-spinner btn landing-btn mt-20 mt-sm-0 action-1 w-full" type="submit" value="Get started" />
		</p>
	</div>
...
<section class="wp-block-tcw-get-touch pt-100 pb-100 bg-dark contact_4 color-filter-dark-7"> <div class="container px-xl-0"> <div class="row justify-content-center justify-content-lg-between align-items-center"> <div class="col-xl-1"> </div> <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 color-white"> <h2 class="small" data-aos="fade-down" data-aos-delay="0">TIME TO SUPERCHARGE YOUR WEBSITE?</h2> <div class="pt-10 pb-20 f-22 text-adaptive" data-aos="fade-down" data-aos-delay="250"> </div> <div data-aos="fade-down" data-aos-delay="500"> <a class="link color-white d-flex align-items-baseline" href="tel:+(03) 8566 8000"> <i class="fas fa-phone fa-flip-horizontal w-30 flex-shrink-0 f-14 text-right"> </i> <div class="text-adaptive"> (03) 8566 8000 </div> </a> <a class="link color-white d-flex align-items-baseline" href="mailto:info@thecreativeworks.com.au"> <i class="fas fa-envelope w-30 flex-shrink-0"> </i> <div class="text-adaptive"> info@thecreativeworks.com.au </div> </a> </div> </div> <div class="col-xl-5 col-lg-6 col-md-8 mt-50 mt-lg-0 bg-light px-50 pt-55 pb-55 radius10" data-aos="fade-down" data-aos-delay="750">
<div class="wp-block-contact-form-7-contact-form-selector">
<div class="wpcf7 no-js" id="wpcf7-f2516-o2" lang="en-US" dir="ltr">
<div class="screen-reader-response"><p role="status" aria-live="polite" aria-atomic="true"></p> <ul></ul></div>
<form action="/campaigns/website-development/?gad_source=1&#038;gclid=EAIaIQobChMI6Y3k8cLhhAMV06tmAh1UDw7tEAAYBCAAEgLwC_D_BwE#wpcf7-f2516-o2" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="2516" />
<input type="hidden" name="_wpcf7_version" value="5.9" />
<input type="hidden" name="_wpcf7_locale" value="en_US" />
