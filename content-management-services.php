...
$page_data = [
    'title' => 'Content Management Services | SanguineIT',
    'description' => 'Enterprise CMS development and support — Sitefinity, Drupal, WordPress portals, multi-site governance, migrations, and managed CMS operations for global organizations.',
    'keywords' => 'CMS development, content management services, Sitefinity, Drupal, WordPress, enterprise CMS, portal development, SanguineIT',
    'canonical' => sit_base_url() . '/content-management-services.php',
];
include 'header.php';
?>
						...
						<div class="row justify-content-center">
							<div class="col-lg-7">
								<div class="bread-titlev2">
									<h1 class="wow fadeInUp" data-wow-delay=".2s" style="color: #fff;">Content Management Services</h1>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/cont_1.jpg', 'Enterprise content management services', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<span>Overview</span>
									<h2>Enterprise CMS Engineering &amp; Governance</h2>
									<p class="lh">SanguineIT helps marketing, IT, and digital experience teams build and operate content management platforms that scale — from multi-brand marketing sites to regulated enterprise portals with workflow governance, SSO, and multi-language publishing.</p>
									<p class="lh">We specialize in <a href="sitefinity.php">Sitefinity</a>, <a href="Drupal.php">Drupal</a>, and <a href="WordPress.php">WordPress</a> — selecting and implementing the right CMS based on your editorial model, integration requirements, and compliance needs rather than forcing a one-size-fits-all platform.</p>
									<p class="lh">From CMS selection and greenfield builds to migrations and long-term support, we offer dedicated CMS squads with ongoing care through our platform-specific maintenance programs.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									<h2>CMS capabilities we deliver</h2>
									<p class="lh">
									<ul class="listing">
									<li><b>Platform selection &amp; strategy —</b> CMS evaluation aligned to editorial workflows, integrations, and total cost of ownership.</li>
									<li><b>Custom development —</b> Modules, widgets, themes, and API integrations tailored to your content model.</li>
									<li><b>Multi-site &amp; multi-language —</b> Regional portals with governance, workflow rules, and translation workflows.</li>
									<li><b>Migration programs —</b> Content and URL migration from legacy CMS platforms with SEO-safe redirects.</li>
									<li><b>Editorial training —</b> Documentation and workshops so marketing teams publish confidently without developer dependency.</li>
									<li><b>Managed CMS support —</b> Security patching, upgrades, and SLA-backed operations through our maintenance services.</li>
</ul>
</p>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/cont_2.jpg', 'CMS portal development and governance', ['class' => 'img-fluid']); ?>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="service pad-tb">
					<div class="container">
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<?php sit_responsive_image('images/about_2/cont_3.jpg', 'Enterprise CMS platform engineering', ['class' => 'img-fluid']); ?>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
						...
						<div class="row upset link-hover">
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
								<div class="s-block">
									...
									<h4>CMS Strategy &amp; Selection</h4>
									<p class="lh">Platform evaluation aligned to editorial needs, integrations, and compliance requirements.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s">
								<div class="s-block">
									...
									<h4>Sitefinity Development</h4>
									<p class="lh">Enterprise portals, upgrades, custom modules, and multi-site governance.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s">
								<div class="s-block">
									...
									<p class="lh">Complex portals, custom modules, migrations, and accessibility compliance.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s">
								<div class="s-block">
									...
									<p class="lh">Marketing sites, WooCommerce, headless CMS, and multisite publishing.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay="1s">
								<div class="s-block">
									...
									<h4>CMS Migration</h4>
									<p class="lh">Content and URL migration with SEO-safe redirects and validation.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay="1.2s">
								<div class="s-block">
									...
									<p class="lh">Patching, upgrades, and SLA-backed operations for production CMS estates.</p>
								</div>
							</div>
						</div>
						<div class="-cta-btn mt70">
							<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.3s">
								<p class="lh">Need a <span>CMS Development Team</span>?</p>
